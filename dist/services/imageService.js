...
exports.createErrorImage = createErrorImage;
/*
 * @Author       : HCLonely
...
// 注册中文字体
const fontsDir = path_1.default.resolve(__dirname, '../../assets/fonts');
(0, canvas_1.registerFont)(path_1.default.join(fontsDir, 'SourceHanSansSC-Regular.otf'), {
...
async function generateSignatureImage(data) {
    ...
    // 使用背景图片
    try {
        const backgroundCanvas = await (0, backgroundService_1.prepareBackground)(layout.width, layout.height);
    ...
    ctx.fillText('IP 签名服务器 • ' + dateStr + ' ' + weekStr, layout.width - 10, layout.height - 8);
    // 重置阴影
    ...
    try {
        ...
        // 添加发光背景
        const gradient = ctx.createRadialGradient(weatherIconX + 35, weatherIconY + 35, 0, weatherIconX + 35, weatherIconY + 35, 40);
